...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 28, 2016 at 10:50 PM
...
--
-- Creation: Feb 23, 2016 at 06:52 PM
--
...
(1, 'In Stock', 'Holden', 'Sedan', 'Commodore', 2014, 24999, 25902, 'Blue', '254HTS', '123365456987324', '6', 'unleaded', 'automatic', 0),
(2, 'In Stock', 'Mazda', 'Hatch', 'Mazda 3', 2012, 18899, 85471, 'Red', '196WRT', '147852369852147', '4', 'unleaded', 'automatic', 0),
...
--
-- Creation: Feb 28, 2016 at 05:44 AM
--
...
--
-- Creation: Feb 23, 2016 at 06:54 PM
--
...
--
-- MIME TYPES FOR TABLE `manufacturer_id`:
--   `MANUFACTURER_ID`
--       `Text_Plain`
--   `manufacturer_id`
--       `Text_Plain`
...
--
-- Creation: Feb 23, 2016 at 06:55 PM
--
...
--
-- Creation: Feb 23, 2016 at 06:56 PM
--
...
--
ALTER TABLE `car`
  MODIFY `stock_no` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Unique ID, containing letters &/or characters,';
--
-- AUTO_INCREMENT for table `customers`
--
ALTER TABLE `customers`
  MODIFY `customer_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Unique ID number, identifying the customer';
--
-- AUTO_INCREMENT for table `sale`
--
ALTER TABLE `sale`
  MODIFY `receipt_no` int(25) NOT NULL AUTO_INCREMENT COMMENT 'The number on the receipt issued to the customer at the point of sale', AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `salesperson`
--
ALTER TABLE `salesperson`
  MODIFY `staff_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'A unique identifying number allocated to each staff member';
--
