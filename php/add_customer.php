...
if ($_POST) {
  ...
  $firstname = $lastname = $street = $city = $state = $postcode = $phone_no = $email = "";
...
$query = "INSERT INTO `customers` (`customer_id`, `firstname`, `surname`, `street`, `city`, `state`, `postcode`, `phone_no`, `email`) 
VALUES (NULL, '$firstname', '$lastname', '$street', '$city', '$state', '$postcode', '$phone_no', '$email');";
                                ...
                                if (isset($_SESSION['security_lev'])) {
                                    ...
                                    if ($_SESSION['security_lev'] == 'Admin') {
                                        echo "<div class='adm_opt'>
                                          ...
                                          <a class='btn btn-primary staff_btns' href='#'>Add<br>Customer</a>
