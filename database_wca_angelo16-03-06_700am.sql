...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 06, 2016 at 10:01 PM
...
(27, 'In Stock', 'Holden', 'Sedan', 'Commodore', 2013, 26999, 65892, 'Red', '', '468546464976546', '6', 'unleaded', 'manual', 0);
...
--
ALTER TABLE `car`
  MODIFY `stock_no` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Unique ID, containing letters &/or characters,', AUTO_INCREMENT=28;
--
-- AUTO_INCREMENT for table `customers`
--
ALTER TABLE `customers`
  MODIFY `customer_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Unique ID number, identifying the customer', AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `sale`
--
ALTER TABLE `sale`
  MODIFY `receipt_no` int(25) NOT NULL AUTO_INCREMENT COMMENT 'The number on the receipt issued to the customer at the point of sale', AUTO_INCREMENT=14;
--
